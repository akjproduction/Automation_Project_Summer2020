...
public class Reusable_Methods_Loggers {
    ...
    //reusable method to click on any element on any websites
    public static void clickUser(WebDriver driver, String locator,String userValue,ExtentTest logger,String elementName){
        //define explicit wait
        WebDriverWait wait = new WebDriverWait(driver,10);
        try{
            System.out.println("Clicking on element " + elementName);
    ...
    public static void dropDownMenu(WebDriver driver, String locator, String userInput,ExtentTest logger, String elementName)
    {
        ...
        catch (Exception err)
        {
            ...
            logger.log(LogStatus.FAIL,"Unable to select element " + err);
            getScreenShot(driver,logger,elementName);
        }
    ...
    /*//scrolling
    public static void scroll(WebDriver driver,String locator,ExtentTest logger,String elementName){
        WebDriverWait wait = new WebDriverWait(driver,10);
        try {
